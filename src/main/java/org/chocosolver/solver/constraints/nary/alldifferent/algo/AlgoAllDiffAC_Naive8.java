...
// */
//public class AlgoAllDiffAC_Naive8 extends AlgoAllDiffAC_Naive {
//
//    //***********************************************************************************
//    // VARIABLES
//    //***********************************************************************************
...
//    // 已访问过的变量和值
//    private byte variable_visited_;
...
//    private byte[] graphLinkedMatrix;
//    private byte[] graphLinkedFrontier;
//
//    // !! 记录gamma的前沿
//    private byte gammaFrontier;
//    // 记录gamma的bitset
//    private byte gammaMask;
//
//    // 变量的论域
////    private NaiveBitSet[] varMask;
//    private byte[] valMask;
//
//    // 记录排除gamma和bind的变量，即notGamma的变量
//    private byte notGammaMask;
//
//    // 内置的bit方法专用的常量
//    protected byte lastMask;
//
//    protected final static int ADDRESS_BITS_PER_WORD = 3;
//    protected final static int BITS_PER_WORD = 1 << ADDRESS_BITS_PER_WORD;
//    protected final static int END_BIT = 32;
//    //    protected final static int BIT_INDEX_MASK = BITS_PER_WORD - 1;
//    /* Used to shift left or right for a partial word mask */
//    protected static final byte WORD_MASK = -128;
...
//    // CONSTRUCTORS
//    //***********************************************************************************
//    public AlgoAllDiffAC_Naive8(IntVar[] variables, ICause cause) {
...
//                valMask[value] |= 1 << node;
////                valMask[value] |= 1 << varIdx;
...
//        for (int i = nextSetBit(gammaFrontier, (byte) 0);
//             i != END_BIT; i = nextSetBit(gammaFrontier, (byte) 0)) {
...
//        for (int i = nextSetBit(gammaMask, (byte) 0); i != END_BIT; i = nextSetBit(gammaMask, (byte) (i + 1))) {
//            notGamma.remove(i);
...
//                graphLinkedMatrix[varIdx] = (byte) (valMask[var2Val[varIdx]] & notGammaMask);
...
//        for (int i = nextSetBit(graphLinkedFrontier[varIdx], (byte) 0);
//             i != END_BIT; i = nextSetBit(graphLinkedFrontier[varIdx], (byte) 0)) {
//            // !! 这里可以将Extended改成Frontier，只记录前沿，记录方法是三个BitSet比较，
...
//    }
//
//    private int nextSetBit(byte word, byte pos) {
////        // HD, Count trailing 0's
////        byte i = (byte) (word & -1 << pos);
////        i = (byte) (~i & (i - 1));
////        if (i <= 0) return i & 32;
////        int n = 1;
////        if (i > 1 << 4) {
...
//}
//
////    private int numberOfTrailingZeros(byte a);
////}
//
