...
public class DomOverWDegCaCd extends AbstractStrategy<IntVar> implements IMonitorContradiction, IMonitorUpBranch {
...
//    protected IntMap p2w;
     ...
     */
    public DomOverWDegCaCd(IntVar[] variables, long seed, IntValueSelector valueSelector) {
        super(variables);
...
//        System.out.println(variable.getId()+"  "+currentVal);
